    ...
    <div className="mt-7">
      ...
      {filter.sort === 'asc' ? (
        <div className="flex bg-slate-200 w-fit gap-2 p-1 items-center">
          <button className="font-semibold" onClick={() => filter.setSort(null)}>X</button>
          <p>Menor Precio</p>
        </div>
      ) : filter.sort === 'desc' ? (
        <div className="flex bg-slate-200 w-fit gap-2 p-1 items-center">
      ...
      {filter.brand === 'Nike' ? (
        <div className="flex bg-slate-200 w-fit gap-2 p-1 items-center">
          <button className="font-semibold" onClick={() => filter.setBrand(null)}>X</button>
          <p>Nike</p>
        </div>
      ) : filter.brand === 'Adidas' ? (
        <div className="flex bg-slate-200 w-fit gap-2 p-1 items-center">
        ...
        <AccordionPanel>
          ...
          <AccordionContent className="p-0">
            <div className="flex flex-col">
              <button onClick={() => filter.setBrand(null)} className={`text-start text-base leading-6 text-gray-900 p-1 py-4 ${filter.brand === null ? "border-l-4 border-black" : ''} `}>TODAS LAS MARCAS</button>
