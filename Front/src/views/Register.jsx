            ...
            <form action="http://localhost:8080/api/auth/register" method="post" className="w-1/2 px-5 py-10 mx-auto flex flex-col gap-2">
                ...
                <div className="relative z-0 w-full mb-5 group">
                    ...
                    <label htmlFor="passwordVal"
                        className="absolute bg-white text-l px-3 text-gray-500 -translate-y-6 translate-x-2 top-3 z-20">Confirmar
                        Contraseña</label>
                </div>
                ...
                <div className="grid md:grid-cols-2 md:gap-6">
                    ...
                    <div className="relative z-0 w-full mb-5 group">
                        <input type="text" name="age" id="age"
                            ...
                            placeholder=" " required />
                        <label htmlFor="age"
                            className="absolute bg-white text-l px-3 text-gray-500 -translate-y-6 translate-x-2 top-3 z-20">Edad</label>
                    </div>
                </div>
                <h2 className="text-l text-gray-500 mb-5 mx-auto">Registrate con GitHub</h2>
                <a href="http://localhost:8080/api/auth/callbackGithub" className="githubBrand mx-auto p-3cursor-pointer"><svg className="w-[46px] h-[46px] text-gray-800 dark:text-white" aria-hidden="true"
