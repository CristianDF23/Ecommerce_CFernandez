                        ...
                        <tr>
                          <td class="es-m-p0r" valign="top" align="center" style="padding:0;Margin:0;width:560px">
                            <table cellpadding="0" cellspacing="0" width="100%" role="presentation"
                              style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                              <tr>
                                <td align="center" bgcolor="#6ea7df" style="padding:0;Margin:0">
                                  <p
                                    style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:53px;color:#333333;font-size:35px">
                                    <span style="font-size:28px"><strong>CSport</strong></span></p>
                                </td>
                              </tr>
                            </table>
                          </td>
                            ...
                            <table cellpadding="0" cellspacing="0" width="100%" role="presentation"
                              ...
                              <tr>
                                <td align="center"
                                  style="padding:0;Margin:0;padding-top:10px;padding-bottom:10px;font-size:0px"><img
                                    src="https://ehtajab.stripocdn.email/content/guids/CABINET_2caaa9549012185d046735eca31983749c909c0c9e803362d510e536aafc718f/images/logo.png"
                                    alt
                              ...
                              <tr>
                                <td align="center" class="es-m-p0r es-m-p0l es-m-txt-c"
                                  ...
                                  <h1
                                    style="Margin:0;line-height:50px;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;font-size:42px;font-style:normal;font-weight:bold;color:#333333">
                              ...
                              <tr>
                                <td align="left" style="padding:0;Margin:0;padding-top:10px">
                                  <p
                                    ...
                                    Después de hacer clic en el botón, se le pedirá que complete los siguientes pasos:
                                  </p>
                                  <ol>
                                    <li
                                      ...
                                      Introduzca una nueva contraseña.</li>
                                    <li
                                      style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;Margin-bottom:15px;margin-left:0;color:#333333;font-size:14px">
                                      Confirma tu nueva contraseña.</li>
                                    <li
                                      style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;Margin-bottom:15px;margin-left:0;color:#333333;font-size:14px">
                                      Haga clic en Enviar.</li>
                                  </ol>
                                </td>
                              </tr>
                            </table>
                            ...
                            <table cellpadding="0" cellspacing="0" width="100%"
                              ...
                              <tr>
                                <td align="center" style="padding:0;Margin:0;padding-top:10px;padding-bottom:10px"><span
                                    ...
                                    style="border-style:solid;border-color:#2CB543;background:#6ea7df;border-width:0px;display:inline-block;border-radius:6px;width:auto"><a
                                      href="http://localhost:5173/restorePass/token=${token}" class="es-button" target="_blank"
                                      style="mso-style-priority:100 !important;text-decoration:none;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;color:#FFFFFF;font-size:20px;padding:10px 30px 10px 30px;display:inline-block;background:#6ea7df;border-radius:6px;font-family:arial, 'helvetica neue', helvetica, sans-serif;font-weight:normal;font-style:normal;line-height:24px;width:auto;text-align:center;mso-padding-alt:0;mso-border-alt:10px solid #6ea7df;padding-left:30px;padding-right:30px">
                                      RESTABLECER TU CONTRASEÑA</a></span></td>
                              </tr>
                              <tr>
                                <td align="center" class="es-m-txt-c" style="padding:0;Margin:0;padding-top:10px">
                                  <h3
                                    ...
                                    Este link es valido para usar una unica vez. Expira en 1 hora.</h3>
                                </td>
                              </tr>
                              <tr>
                                <td align="center" style="padding:0;Margin:0;padding-top:10px;padding-bottom:10px">
                                  <p
                                    style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;font-size:14px">
                                    Si no solicitó restablecer su contraseña, ignore este mensaje o comuníquese con
                                    nuestro departamento de servicio al cliente.</p>
                                </td>
                              </tr>
                            </table>
                          </td>
