export const mailDeletedAccount = () => {
    return `
    <!DOCTYPE html>
<html lang="en">
<head>
...
<body>
    <div class="email-container">
        ...
        <p>Le comunicamos que su cuenta ha sido eliminada por inactividad superior a los 2 días.</p>
        <p>Si cree que esto ha sido un error o desea reactivar su cuenta, por favor, póngase en contacto con nosotros a través de la información proporcionada a continuación.</p>
